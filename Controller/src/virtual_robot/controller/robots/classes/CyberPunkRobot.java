...
//Not working yet
@BotConfig(name = "CyberPunk Bot", filename = "cyberpunk")
public class CyberPunkRobot extends MechanumBase {
...
//    private DeadWheelEncoder xEncoder = null;
    ...
    private final double WHEEL_DIAMETER = 3.937007874;
    ...
    public void initialize(){
        ...
        motors = new DcMotorExImpl[]{
                (DcMotorExImpl)hardwareMap.get(DcMotorEx.class,"stangaSpate"),
                (DcMotorExImpl)hardwareMap.get(DcMotorEx.class,"stangaFata"),
                (DcMotorExImpl)hardwareMap.get(DcMotorEx.class,"dreaptaFata"),
                (DcMotorExImpl)hardwareMap.get(DcMotorEx.class, "dreaptaSpate")
        };
...
//        xEncoder = hardwareMap.get(DeadWheelEncoder.class, "enc_x");
    ...
    protected void createHardwareMap(){
        ...
        String[] motorNames = new String[] {"stangaSpate", "stangaFata", "dreaptaFata", "dreaptaSpate"};
